...
| MA-75 | U | status posture rules: healthy GREEN; fillable/unknown/index-behind/no-schedule/never-ran/unreadable/stale/other-host/scheduler-unavailable/not-installed/moved-binary/cancelled WARN; failed/never-finished/exe-missing RED, each with a remedy; liveness of a running record comes from the archive lock, not a pid; auth failure adds the rotation remedy; the CLI reports a real archive (exit 0) and refuses a directory with neither manifest nor descriptor | R18, R12, S29 |
