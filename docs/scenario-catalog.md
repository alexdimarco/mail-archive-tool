...
| MA-145 | U | the envelope Fingerprint (and the fallback content Identity) is unchanged when only TransportHeaders differs — the sender-influenced block is excluded from identity and never indexed | R3, R1, S32 |
